...
<?php endforeach; if(!$products): ?><tr><td colspan="<?= $canViewCost ? 13 : 12 ?>" style="text-align:center;padding:30px;color:#718096">Không tìm thấy sản phẩm phù hợp.</td></tr><?php endif; ?>
</tbody></table></div>
