...
<section class="block"><div class="wrap"><div class="sec-card">
  ...
  <?php else:?><div class="voucher-grid"><?php foreach($vouchers as $v):?>
    <div class="voucher-card"><div class="code"><?=e($v['code'])?></div><div class="desc"><?=e($v['description']??'')?></div><div class="exp fs-12 text-muted">HSD: <?= !empty($v['valid_to']) ? date('d/m/Y',strtotime($v['valid_to'])) : '—' ?></div></div>
