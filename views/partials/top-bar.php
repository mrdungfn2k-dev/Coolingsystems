...
<div class="top-bar">
  <div class="wrap">
    <!-- Dedicated Mobile Links Bar (100% Centered, Zero Overflow) -->
    <div class="top-bar-mobile-links">
      ...
      <button class="m-lang-btn" onclick="switchLang()">EN/VI</button>
      <?php if (!empty($user)): ?>
        <span class="m-sep">•</span>
        <a href="<?= ($user['role']??'')==='admin' ? '/admin/logout' : '/auth/logout' ?>" class="m-logout-btn">Đăng xuất</a>
      <?php endif; ?>
    </div>
    ...
    <div class="right desktop-only-right" style="display:flex;align-items:center;gap:10px">
...
.top-bar-mobile-links { display: none !important; }
...
@media (max-width: 768px) {
  .desktop-only-right { display: none !important; }
  ...
  .top-bar .wrap { display: flex !important; flex-direction: column !important; align-items: center !important; justify-content: center !important; padding: 0 8px !important; width: 100% !important; box-sizing: border-box !important; gap: 4px !important; }
  ...
  .top-bar-mobile-links a { color: rgba(255,255,255,0.95) !important; font-size: 11.5px !important; font-weight: 600 !important; text-decoration: none !important; white-space: nowrap !important; }
  .top-bar-mobile-links .m-sep { color: rgba(255,255,255,0.35) !important; font-size: 10px !important; }
  .top-bar-mobile-links .m-lang-btn { background: none !important; border: 1px solid rgba(255,255,255,0.4) !important; color: #fff !important; padding: 2px 7px !important; border-radius: 4px !important; font-size: 10.5px !important; font-weight: 700 !important; cursor: pointer !important; white-space: nowrap !important; }
  .top-bar-mobile-links .m-logout-btn { background: #e74c3c !important; color: #fff !important; padding: 2px 6px !important; border-radius: 4px !important; font-size: 10px !important; font-weight: 700 !important; text-decoration: none !important; white-space: nowrap !important; }

  .top-bar .left { width: 100% !important; display: flex !important; justify-content: center !important; margin-bottom: 2px !important; }
  .top-bar .left .badge-live { font-size: 9.5px !important; padding: 2px 6px !important; line-height: 1.2 !important; white-space: nowrap !important; }
  ...
  .top-bar-hotline-stream .hotline-list { display: flex !important; flex-wrap: wrap !important; justify-content: center !important; align-items: center !important; white-space: normal !important; gap: 2px 8px !important; width: 100% !important; }
  .top-bar-hotline-stream .hotline-pill { font-size: 10.5px !important; padding: 0 2px !important; }
  .top-bar-hotline-stream .h-label { font-size: 9.5px !important; }
