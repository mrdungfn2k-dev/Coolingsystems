...
<div class="dash">
  <aside class="dash-sidebar">
    ...
    <nav class="dash-nav">
      ...
      <a href="/admin/commissions" class="<?= startsWith(currentPath(),'/admin/commissions')?'active':'' ?>"><?= sbIcon('list') ?>Hoa hồng đối tác</a>
      ...
      <a href="/admin/quotations" class="<?= startsWith(currentPath(),'/admin/quotations')?'active':'' ?>"><?= sbIcon('filetext') ?>Báo giá độc lập</a>
...
$_abcMap = [
    ...
    '/admin/garages' => 'Garage khách hàng',
