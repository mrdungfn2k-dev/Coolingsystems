...
@media(max-width: 768px) {
  header.main { min-height: auto !important; padding: 4px 0 2px 0 !important; background: #fff !important; margin: 0 !important; border-bottom: 1px solid #f1f5f9 !important; }
  header.main .wrap { 
    display: flex !important; 
